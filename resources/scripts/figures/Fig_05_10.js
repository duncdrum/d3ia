...
dataViz(data.tweets)
    ...
    function dataViz(incData) {
     ...
     /* packableTweets = d3.hierarchy({id: "root", values: nestedTweets}, function children(d) {return d.children ;})
	  .sum(function(d) { return 1;  });*/
	  
    packableTweets = d3.hierarchy({id: "root", values: nestedTweets}, function children(d) {return d.values})
    .eachBefore(function(d) { return 1;  })
    .sum(function(d) {d.values ? 1 : 0});
